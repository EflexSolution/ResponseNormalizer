// src/lib.rs
/*
 * Core library for ResponseNormalizer
 */
...
#[derive(Debug)]
pub struct ResponseNormalizerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ResponseNormalizerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ResponseNormalizer processing");
    
    let mut processor = ResponseNormalizerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ResponseNormalizerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ResponseNormalizerProcessor::new(false);
